...
export default class ListingsContainer extends Component {
  render() {
    const imgSrc = 'https://react.semantic-ui.com/images/wireframe/image.png';
    ...
    return (
      this.props.listings.map((listing) => (
        <ListingCard
          ...
          meta={listing.price}
          imgSrc={"https://maps.googleapis.com/maps/api/staticmap?center="
            + listing.latitude + "," + listing.longitude + "&zoom=14&size=400x300&key=AIzaSyD-X42BKQuA-ao5n2sNFbaz0vQabOkRX0s"}
